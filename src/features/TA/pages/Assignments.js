          ...
          <div className="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
            <div className="modal-content">
              ...
              <div className="modal-body">
                {/* Title */}
                <div className="mb-4">
                  <h4 className="mb-2">{viewingAssignment.title}</h4>
                  <span className="badge bg-primary">งาน</span>
                </div>
                ...
                <div className="mb-4">
                  ...
                  <p className="border-start border-3 border-primary ps-3" style={{ whiteSpace: "pre-wrap" }}>
                    {viewingAssignment.description || "ไม่มีรายละเอียด"}
                  </p>
                </div>
                ...
                <div className="row g-3 mb-4">
                  <div className="col-md-6">
                    <div className="info-card p-3 bg-light rounded">
                      <div className="d-flex align-items-center">
                        <i className="bi bi-calendar3 fs-4 text-primary me-3" />
                        <div>
                          <small className="text-muted d-block">กำหนดส่ง</small>
                          <strong>
                            {viewingAssignment.dueDate
                              ? new Date(viewingAssignment.dueDate).toLocaleString("th-TH", {
                                  year: "numeric",
                                  month: "long",
                                  day: "numeric",
                                  hour: "2-digit",
                  ...
                  <div className="col-md-6">
                    <div className="info-card p-3 bg-light rounded">
                      <div className="d-flex align-items-center">
                        <i className="bi bi-trophy fs-4 text-warning me-3" />
                        <div>
                          <small className="text-muted d-block">คะแนนเต็ม</small>
                          <strong>{viewingAssignment.maxScore ?? "-"}</strong>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                {/* Links */}
                {!!viewingAssignment.links?.length && (
                  <div className="mb-4">
                    <h6 className="text-muted mb-3">
                      <i className="bi bi-link-45deg me-2" />
                      ลิงก์อ้างอิง ({viewingAssignment.links.length})
                    </h6>
                    <div className="list-group">
                      {viewingAssignment.links.map((link, i) => (
                        <a
                          key={i}
                          href={link}
                          target="_blank"
                ...
                {/* Attachments */}
                {!!viewingAssignment.attachments?.length && (
                  <div className="mb-4">
                    <h6 className="text-muted mb-3">
                      <i className="bi bi-paperclip me-2" />
                      ไฟล์แนบ ({viewingAssignment.attachments.length})
                    </h6>
                    <div className="list-group">
